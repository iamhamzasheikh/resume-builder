...
import { Plus, UploadCloudIcon, UploadCloud, FilePenLineIcon, TrashIcon, PencilIcon, XIcon, LoaderCircleIcon } from 'lucide-react'
  ...
  return (
    <div>
      <div className='max-w-7xl mx-auto px-4 py-8'>
        <p className=' text-2xl font-medium mb-6 bg-gradient-to-r from-slate-600 to bg-slate-700
        ...
        border-slate-300 group hover:border-indigo-500 hover: shadow-lg transition-all
          duration-300 cursor-pointer'>
            <Plus className='size-11 translate-all duration-300 p-2.5
        ...
        border-slate-300 group hover:border-purple-500 hover: shadow-lg transition-all
          duration-300 cursor-pointer'>
            <UploadCloudIcon className='size-11 translate-all duration-300 p-2.5
          ...
          z-10 flex items-center justify-center'>
            ...
            max-w-sm p-6'>
              ...
              <input onChange={(e) => setTitle(e.target.value)} value={title}
                className='w-full px-4 py-2 mb-2 focus:border-green-600'
                required
                type="text"
