        ...
        <>
            ...
            <footer className="flex flex-wrap justify-center lg:justify-between overflow-hidden
             gap-10 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px]
              text-gray-500 mt-40 bg-gradient-to-r from-white via-green-200/60 to-white ">
                ...
                <div className="flex flex-col max-md:items-center max-md:text-center gap-2 items-end">
                    ...
                    <p className="mt-3 text-center">© 2025
                        <a className='text-green-950 cursor-pointer hover:text-green-600'
                            href="#">&nbsp;Resume Builder
                        </a>
                    </p>
                </div>
