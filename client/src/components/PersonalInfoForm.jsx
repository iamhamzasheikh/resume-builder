    ...
    return (
        <div>
            ...
            <div className="flex items-center gap-2">
                <label >
                    {data.image ? (
                        <img className='w-16 h-16 rounded-full object-cover mt-5 ring
                    ...
                    <input onChange={(e) => { handleChange('image', e.target.files[0]) }}
                        className='hidden' type="file" accept='image/jpeg, image/png' />
                </label>
                {typeof data.image === 'object' && (
                    <div className='flex flex-col gap-1 pl-4 text-sm'>
                        ...
                        text-gray-900 gap-3'>
                            ...
                            <div className='relative w-9 h-5 bg-slate-300 rounded-full peer
