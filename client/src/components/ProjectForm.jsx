                    ...
                    <div key={index} className='p-4 border border-gray-200 rounded-lg space-y-3'>
                        ...
                        <div className='grid gap-3'>
                            ...
                            <input value={project.type || ""} onChange={(e) => updateProject(index, 'type', e.target.value)}
                                type="text" placeholder="Enter Project Type" className='px-3 py-2 text-sm rounded-lg' />

                            <textarea value={project.description || ""} onChange={(e) => updateProject(index, 'description', e.target.value)}
                                type="text" rows={4} placeholder="Describe your project..."
                                className='w-full px-3 py-2 text-sm rounded-lg resize-none outline-none border border-gray-300' />
                        </div>
