    ...
    try {
        ...
        const response = await ai.chat.completion.create({
            ...
            messages: [
                {
                    role: "system",
                    content: "Your task is to enhance the professional summary of a resume. The summary should be 1-2 sentences also highlighting key skills, experience, and career objectives. Make it compelling and ATS-friendly. and only return text no options or anything else."
                },
